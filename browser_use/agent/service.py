...
from browser_use.agent.screenshot import save_screenshot
...
class Agent(Generic[Context]):
	...
	async def step(self, step_info: Optional[AgentStepInfo] = None) -> None:
		...
		try:
			...
			if state.screenshot_original and self.settings.save_conversation_path:
				path = self.settings.save_conversation_path + f'_{self.state.n_steps}.png'
				save_screenshot(state.screenshot_original, path)
